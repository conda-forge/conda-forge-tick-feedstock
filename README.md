About conda-forge-tick-feedstock
================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/conda-forge-tick-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/conda-forge-tick-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add conda-forge-tick
# for installing globally
pixi global install conda-forge-tick
```
...
It is possible to list all of the versions of `conda-forge-tick` available on your platform:
...
```
pixi search conda-forge-tick --channel conda-forge
```
